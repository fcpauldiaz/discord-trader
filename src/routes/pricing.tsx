      ...
      <section className="marketing-section marketing-section-white">
        <div className="page-wrap px-4 sm:px-6 lg:px-8">
          <div className="section-head">
            <span className="section-badge section-badge-yellow">Pricing</span>
            <h1 className="marketing-section-title">Simple plans</h1>
            <p className="marketing-section-subtitle">Start free, upgrade when you are ready to automate execution.</p>
          </div>
